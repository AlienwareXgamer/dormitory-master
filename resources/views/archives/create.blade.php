...
@section('content')
    <div class="container">
        <h1>Add Archive to Room {{ $aroom->id }}</h1>
        ...
        <form action="{{ route('archives.store', $aroom) }}" method="POST">
            @csrf

            <div class="form-group">
                <input type="hidden" name="aroom_id" value="{{ $aroom->id }}">
            ...
            <div class="form-group">
                ...
                border-width: 2px;" name="last_name"
                    id="last_name" class="form-control" value="{{ old('last_name') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                border-width: 2px;" name="address"
                    id="address" class="form-control" value="{{ old('address') }}" required>
            </div>
