<?php $__env->startSection('content'); ?>
   ...
   <div class="mt-4 ml-80">
        <form action="<?php echo e(route('service_requests.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <label for="name" class="text-l font-semibold font-Montserrat" style="margin-left: 0rem; color: #888888">Name:</label>
            <input class="form-control drop-shadow-2xl bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 pl-2 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" style="color: #22215B; margin-top: 1rem; "type="text" name="name"><br>
            <label for="tenant_id" class="text-l font-semibold font-Montserrat" style="margin-left: 0rem; color: #888888">Requested By:</label>
            <select class="form-control drop-shadow-2xl bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 pl-2 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" style="color: #22215B; margin-top: 1rem; "name="tenant_id" id="tenant_id" class="form-control">
            ...
            <br>
            <label for="room_id" class="text-l font-semibold font-Montserrat" style="margin-left: 0rem; color: #888888">Room</label>
            <input class="form-control drop-shadow-2xl bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 pl-2 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" style="color: #22215B; margin-top: 1rem; "type="text" name="room_id" id="room_id" class="form-control">
            <button type="submit" class="drop-shadow-2xl mt-8 text-xl text-white bg-primary-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-md px-10 py-2.5 sm:text-center " style="background-color:#22215B; height: 3.5rem; width: 50rem;">Create Service Request</button>
        </form>
      </div>
        ...
        <div class="grid h-full place-items-center">
            <div class="sm:w-3/4 rounded overflow-hidden shadow-lg" style="background-color: #ee1a1a4a;">
              ...
              <p1 class="block" style="color: #F6980A;"><?php echo e(ucfirst(str_replace('_', ' ', $serviceRequest->status))); ?></p1>
            </div>
              </div>
