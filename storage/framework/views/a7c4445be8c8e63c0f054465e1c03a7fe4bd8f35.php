...
<?php endif; ?>
<div style="margin: 0rem;" class="w-screen">
    <div class="w-full bg-cover bg-bottom" style="height: 60rem; background-image: url(/assets/background.png);">
      ...
      <div style="padding-top: 1rem; width: 50rem; margin-right: 2rem;">
        <div class="container place-items-center">
                        <div class="panel-body place-items-center">
                            <form action="<?php echo e(route('leave_contracts.store')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="mb-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FRANCIS ALLEN\Dormitory-Management-System-master\resources\views/leavecontracts/index.blade.php ENDPATH**/ ?>