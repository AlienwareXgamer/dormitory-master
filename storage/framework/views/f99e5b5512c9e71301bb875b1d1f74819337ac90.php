...
<div class="items-center py-10 text-center mx-6 font-Montserrat">
  ...
  <div onclick="location.href='pending-contracts'" class="inline-block md:w-32 lg:w-60 sm:mx-6 sm:mt-3 sm:max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #ffffff">
...
<div class="items-center py-10 text-center mx-6 font-Montserrat">
  ...
  <div onclick="location.href='leave-contracts'" class="inline-block md:w-32 lg:w-60 sm:mx-6 sm:mt-3 sm:max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #ffffff">
  ...
  <div onclick="location.href='statuses'" class="inline-block md:w-32 lg:w-60 sm:mx-6 sm:mt-3 sm:max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #ffffff">
  ...
  <div onclick="location.href='arooms'" class="inline-block md:w-32 lg:w-60 sm:mx-6 sm:mt-3 sm:max-w-sm rounded overflow-hidden shadow-lg" style="background-color: #ffffff">
